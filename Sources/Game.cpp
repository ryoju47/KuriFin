...
// TODO: 砲台の位置を画面左に、ターゲットの位置を画面右に移動させる。(A) HW16A118_谷口遼樹
// TODO: 雲の位置を左から右に動かす。見えなくなったら左端に戻す。(B) HW16A118_谷口遼樹
// TODO: 砲台を青い壁に沿って上下に動かす。(C) HW16A118_谷口遼樹
